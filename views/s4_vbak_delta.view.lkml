view: s4_vbak_delta {
  sql_table_name: "COE_TRYOUTS"."s4_vbak_delta"
    ;;
  ...
  dimension: input_2_mandt {
    type: string
    sql: ${TABLE}."Input_#2_MANDT" ;;
  }

  dimension: input_2_vbeln {
    type: string
    sql: ${TABLE}."Input_#2_VBELN" ;;
  }

  dimension: input_3_costa {
    type: string
    sql: ${TABLE}."Input_#3_COSTA" ;;
  }

  dimension: input_3_mandt {
    type: string
    sql: ${TABLE}."Input_#3_MANDT" ;;
  }

  dimension: input_3_vbeln {
    type: string
    sql: ${TABLE}."Input_#3_VBELN" ;;
  }
